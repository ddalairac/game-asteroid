...
console.log("%c" + ascii_logo +
    ...
    "%c" + ascii_iso2 +
    "%c" + ascii_by +
    "%c" + ascii_github, 'background: #222; color: white;', 'background: #222; color: #bada55;', 'background: #222; color: white;', 'background: #222; color: white;', 'background: #222; color: #bada55;');
